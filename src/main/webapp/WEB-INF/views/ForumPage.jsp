...
<link rel="stylesheet" href="resources/css/ForumPage.css" media="screen">
    ...
    <meta property="og:title" content="ForumPage">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-custom-color-3 u-section-1" id="sec-0ee5">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-left u-text u-text-1">FORUM</p>
        <p class="u-align-left u-text u-text-default u-text-2">자유롭게 이야기를 나눠보세요</p>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-22d4" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="제목을 입력하세요" id="name-22d4" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-22d4" class="u-form-control-hidden u-label"></label>
              <textarea placeholder="내용을 입력하세요." rows="4" cols="50" id="message-22d4" name="message" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></textarea>
            </div>
            <div class="u-form-email u-form-group">
              <label for="email-22d4" class="u-form-control-hidden u-label"></label>
              <input type="email" placeholder="사진 첨부가 가능합니다." id="email-22d4" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-align-center u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-grey-75 u-radius-30 u-btn-1">Submit</a>
    ...
    <section class="u-clearfix u-section-2" id="sec-ccf7">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-container-style u-group u-group-1">
          <div class="u-container-layout">
            <p class="u-align-left u-text u-text-1">2021.1.4.18:14</p>
            <p class="u-text u-text-default u-text-2">조회수</p>
            <p class="u-align-left u-text u-text-3">댓글</p>
            <p class="u-text u-text-default u-text-4">5</p>
            <p class="u-text u-text-custom-color-2 u-text-default u-text-5">5</p>
            <p class="u-text u-text-default u-text-6">아이디</p>
            <p class="u-text u-text-default u-text-7">안녕하세요. 좋은 아침입니다.</p>
            <p class="u-text u-text-default u-text-grey-70 u-text-8">안녕하세요. 좋은 아침입니다. 질문드립니다. ​안녕하세요. 좋은 아침입니다. 질문드립니다.안녕하세요.&nbsp;<br>안녕하세요. 좋은 아침입니다. 질문드립니다.안녕하세요. 좋은 아침입니다. 질문드립니다.안녕하세...<br>
            </p>
            <p class="u-text u-text-default u-text-9">
              <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-grey-90 u-btn-1" href="HomePage.html" data-page-id="342306138">신고</a>
            </p>
          </div>
        </div>
        <div class="u-border-1 u-border-grey-15 u-line u-line-horizontal u-line-1"></div>
        <a href="https://nicepage.com/k/aesthetic-website-templates" class="u-border-none u-btn u-btn-round u-button-style u-grey-70 u-hover-grey-50 u-radius-50 u-btn-2">더보기</a>
      </div>
    </section>
    <section class="u-clearfix u-section-3" id="sec-e9bc">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom" name="form-1" style="padding: 10px;">
            <input type="hidden" id="siteId" name="siteId" value="1020404250">
            <input type="hidden" id="pageId" name="pageId" value="54479990">
            <div class="u-form-group u-form-select u-form-group-1">
              <label for="select-251a" class="u-form-control-hidden u-label"></label>
              <div class="u-form-select-wrapper">
                <select id="select-251a" name="select" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            ...
            <div class="u-form-group u-form-group-2">
              <label for="text-f4d9" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="" id="text-f4d9" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
