...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="비밀번호 확인">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>PwCheck</title>
    <link rel="stylesheet" href="resources/css/nicepage.css" media="screen">
<link rel="stylesheet" href="resources/css/PwCheck.css" media="screen">
    ...
    <meta property="og:title" content="PwCheck">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-7b89">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default u-text-3">비밀번호 확인</h2>
        <div class="u-border-3 u-border-grey-dark-1 u-line u-line-horizontal u-line-1"></div>
        <h5 class="u-text u-text-default u-text-4">개인 정보 수정을 위해 비밀번호 부탁 드립니다.</h5>
        ...
        <h6 class="u-text u-text-12">아이디 :&nbsp;</h6>
        <h5 class="u-text u-text-13">회원 아이디</h5>
        <h6 class="u-text u-text-14">비밀번호 :&nbsp;</h6>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-group-1">
              <label for="text-8a64" class="u-form-control-hidden u-label"></label>
              <input type="text" placeholder="" id="text-8a64" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
            <div class="u-align-right u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-grey-75 u-btn-2">확인<br>
              </a>
        ...
        <p class="u-text u-text-palette-2-base u-text-15">비밀번호가 ​일치하지 않습니다. </p>
      </div>
    </section>
