...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="관리자 목록">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>AdminList</title>
    <link rel="stylesheet" href="resources/css/nicepage.css" media="screen">
<link rel="stylesheet" href="resources/css/AdminList.css" media="screen">
    ...
    <meta property="og:title" content="AdminList">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-af1d">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default u-text-3">관리자 목록</h2>
        ...
        <h6 class="u-text u-text-default u-text-palette-2-base u-text-4">회원정보를 찾을 수 없습니다. </h6>
        <h5 class="u-text u-text-custom-color-4 u-text-default u-text-5">관리자 등록이 가능한 아이디 입니다.</h5>
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">이름</th>
                <th class="u-border-1 u-border-black u-table-cell">이메일</th>
                <th class="u-border-1 u-border-black u-table-cell">전화번호</th>
                <th class="u-border-1 u-border-black u-table-cell">관리자삭제</th>
              </tr>
            </thead>
