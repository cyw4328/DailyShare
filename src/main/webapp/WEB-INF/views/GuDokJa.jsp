...
<link rel="stylesheet" href="resources/css/GuDokJa.css" media="screen">
    ...
    <meta property="og:title" content="GuDokJa">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-87a9">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default u-text-3">구독 블로거 관리</h2>
        ...
        <p class="u-text u-text-default u-text-4">현재 나를 구독하는 블로거는&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;명입니다.</p>
        <div class="u-tab-links-align-right u-tabs u-tabs-1">
          <ul class="u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item u-tab-item-1" role="presentation">
              <a class="active u-button-style u-tab-link u-tab-link-1" id="link-tab-3714" href="#tab-3714" role="tab" aria-controls="tab-3714" aria-selected="true">나를 구독한 블로거</a>
            </li>
            <li class="u-tab-item u-tab-item-2" role="presentation">
              <a class="u-button-style u-tab-link u-tab-link-2" id="link-tab-bd4f" href="#tab-bd4f" role="tab" aria-controls="tab-bd4f" aria-selected="false"> 내가 구독한 블로거</a>
            </li>
          </ul>
          <div class="u-tab-content">
            <div class="u-container-style u-tab-active u-tab-pane u-tab-pane-1" id="tab-3714" role="tabpanel" aria-labelledby="link-tab-3714">
                  ...
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-body">
                      <tr style="height: 74px;">
                        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">구독자1</td>
            ...
            <div class="u-container-style u-tab-pane u-tab-pane-2" id="tab-bd4f" role="tabpanel" aria-labelledby="link-tab-bd4f">
              <div class="u-container-layout u-container-layout-3">
                <div class="u-table u-table-responsive u-table-2">
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-body">
                      <tr style="height: 74px;">
                        <td class="u-border-1 u-border-grey-dark-1 u-table-cell">구독자2</td>
                        <td class="u-border-1 u-border-grey-dark-1 u-table-cell"></td>
                      </tr>
                      <tr style="height: 74px;">
                        <td class="u-border-1 u-border-grey-dark-1 u-table-cell"></td>
          ...
          <div class="u-repeater u-repeater-1">
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-4">
                <h5 class="u-text u-text-default u-text-5">개인정보수정</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-5">
                <h5 class="u-text u-text-default u-text-6">구독관리</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-6">
                <h5 class="u-text u-text-default u-text-7">알림목록</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-7">
                <h5 class="u-text u-text-default u-text-8">차단관리</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-8">
                <h5 class="u-text u-text-default u-text-9">블로그메뉴</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-9">
                <h5 class="u-text u-text-default u-text-10">MY 게시글</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-10">
                <h5 class="u-text u-text-default u-text-11">MY 댓글</h5>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="u-align-center u-clearfix u-grey-15 u-section-2" id="sec-ec84">
