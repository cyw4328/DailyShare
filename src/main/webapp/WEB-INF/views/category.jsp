...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="카테고리 목록">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Category</title>
    <link rel="stylesheet" href="resources/css/nicepage.css" media="screen">
<link rel="stylesheet" href="resources/css/Category.css" media="screen">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-0855">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default u-text-3">카테고리 목록</h2>
          ...
          <div class="u-repeater u-repeater-1">
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-2">
                <h5 class="u-text u-text-default u-text-6">회원목록</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-3">
                <h5 class="u-text u-text-default u-text-7">신고목록</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-4">
                <h5 class="u-text u-text-default u-text-8">제재목록</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-5">
                <h5 class="u-text u-text-default u-text-9">관리자목록</h5>
              </div>
            </div>
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-6">
                <h5 class="u-text u-text-default u-text-10">카테고리목록</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <a href="https://nicepage.com/website-design" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5"> 수정</a>
        <a href="https://nicepage.com/website-design" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-6">삭제</a>
        <a href="https://nicepage.com/website-design" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-7">삭제</a>
        <a href="https://nicepage.com/c/tabs-website-templates" class="u-black u-border-none u-btn u-btn-round u-button-style u-hover-grey-15 u-radius-6 u-btn-8">저장</a>
      </div>
    </section>
