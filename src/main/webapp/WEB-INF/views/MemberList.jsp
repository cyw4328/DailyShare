...
<link rel="stylesheet" href="resources/css/MemberList.css" media="screen">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-86a0">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-align-left u-text u-text-default u-text-3">회원목록</h2>
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 77px;">
                <th class="u-border-1 u-border-black u-table-cell u-table-cell-1">아이디</th>
                <th class="u-border-1 u-border-black u-table-cell u-table-cell-2">이름</th>
                <th class="u-border-1 u-border-black u-table-cell">이메일</th>
                <th class="u-border-1 u-border-black u-table-cell">전화번호</th>
                <th class="u-border-1 u-border-black u-table-cell">가입날짜</th>
                <th class="u-border-1 u-border-black u-table-cell">회원탈퇴여부</th>
                <th class="u-border-1 u-border-black u-table-cell">회원제재상태</th>
              </tr>
            </thead>
            <tbody class="u-table-body">
              ...
              <tr style="height: 84px;">
                ...
                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-37"></td>
                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-38"></td>
                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-39"></td>
                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-40"></td>
                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-41"></td>
                <td class="u-border-3 u-border-grey-30 u-table-cell u-table-cell-42"></td>
              </tr>
            </tbody>
          </table>
        </div>
