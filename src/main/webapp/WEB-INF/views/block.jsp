...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="차단 목록 관리">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Block</title>
    <link rel="stylesheet" href="resources/css/nicepage.css" media="screen">
<link rel="stylesheet" href="resources/css/Block.css" media="screen">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-2dfb">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-default u-text-3">차단 목록 관리</h2>
        ...
        <p class="u-text u-text-default u-text-4">현재 내가 차단하고 있는 블로거는 00명입니다.</p>
