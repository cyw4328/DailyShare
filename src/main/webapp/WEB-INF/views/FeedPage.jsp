...
<link rel="stylesheet" href="resources/css/FeedPage.css" media="screen">
    ...
    <meta property="og:title" content="FeedPage">
...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="carousel_e7df">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-align-left u-text u-text-1">FEED<span style="font-size: 1.125rem;">
            <span style="font-size: 1.5rem;"></span>
          </span>
          <br>
        </p>
        <p class="u-text u-text-default u-text-2">내가 구독하는 글 입니다</p>
        <p class="u-align-left u-text u-text-default u-text-3">구독중</p>
        <p class="u-text u-text-default u-text-4">구독자</p>
        <div class="u-border-2 u-border-grey-90 u-expanded-width u-line u-line-horizontal u-line-1"></div>
      </div>
    </section>
